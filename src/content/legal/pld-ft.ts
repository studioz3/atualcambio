...
export const blocks: LegalBlock[] = [
  {
    "id": "circular-no-3-978-20",
    "title": "Circular nº 3.978/20",
    "body": [
      {
        "type": "p",
  ...
  },
  {
    ...
    "body": [
      {
        "type": "p",
        "text": "Definições complementares – ativos virtuais (criptoativos)"
      },
      {
        "type": "p",
        "text": "No contexto desta Política, quando aplicável à atuação da Atual Câmbio e/ou de suas parcerias e integrações tecnológicas, consideram-se também os seguintes conceitos operacionais relacionados a ativos virtuais (criptoativos):"
      },
      {
        "type": "ul",
        "items": [
  ...
  },
  {
    ...
    "body": [
      ...
      {
        "type": "p",
        "text": "Determinar a estrutura organizacional, funções e responsabilidades necessários para o eficiente cumprimento das atividades de PLD/FT, assim enfatizando a governança que a Atual Câmbio exerce acerca do tema."
      },
      {
        "type": "p",
        "text": "O presente documento é compatível com os perfis de risco determinados pela Circular 3.978/20. A Atual Corretora de Câmbio é uma instituição financeira homologada pelo Banco Central do Brasil, em 19 de julho de 2024, alocada na segmentação S4 da regulação prudencial determinada pelo Conselho Monetário Nacional."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Os riscos requeridos pela Circular 3.978/20 (Prospects e Clientes, Produtos e Serviços, Colaboradores, Fornecedores e Prestadores de Serviços) estão tratados em manuais apartados com os procedimentos de identificação, qualificação e classificação desses terceiros, de acordo com as respectivas categorias de risco determinadas pela Atual Câmbio."
      },
      {
        "type": "p",
        "text": "O diretor responsável pela atividade de Prevenção à Lavagem de Dinheiro e ao Financiamento do Terrorismo (conforme Circular 3.978/20) consta registrado no UNICAD e na Ata de Eleição da Diretoria como responsável pelo cumprimento das diretrizes do respectivo normativo."
      },
      {
        "type": "p",
        "text": "Compete ao departamento de Controles Internos a execução e o gerenciamento das atividades emanadas da atividade de PLD.FT, recebendo para isso instruções claras e precisas dos objetivos esperados do diretor responsável pela Circular 3.978/20."
      },
      {
        "type": "p",
        "text": "O conteúdo descrito nessa política não tem prazo de validade, mas caso haja necessidade de atualização, o departamento de Controles Internos realizará sua atualização, nos termos do artigo 7 da Circular 3.978/20."
      },
      {
        "type": "p",
        "text": "A divulgação de novas versões de documentos corporativos da Atual Câmbio é realizada através da caixa de e-mail controles.internos@atualcambio.com.br, via “Declaração de Recebimento”, ou outro meio que evidencie o recebimento ao seu público-alvo."
      }
    ]
  },
  {
    "id": "5-tematica-lavagem-de-dinheiro-e-o-finan",
    "title": "5. TEMÁTICA LAVAGEM DE DINHEIRO E O FINANCIAMENTO DO TERRORISMO",
    "body": [
      {
        "type": "p",
  ...
  {
    "id": "7-abordagem-baseada-em-risco",
    "title": "7. ABORDAGEM BASEADA EM RISCO",
    "body": [
      {
        "type": "p",
        "text": "A abordagem baseada em risco (ABR) consiste na metodologia de análise individual de transações visando a aplicação de medidas mitigatórias de Prevenção à Lavagem de Dinheiro e Financiamento ao Terrorismo (PLD.FT). Visa estabelecer sistemas e controles que sejam condizentes com os riscos de lavagem de dinheiro e financiamento ao terrorismo. Na Atual Câmbio é realizado em 3 (três) etapas:"
      },
      {
        "type": "ul",
        "items": [
  ...
  {
    "id": "8-categorias-de-risco",
    "title": "8. CATEGORIAS DE RISCO",
    "body": [
      {
        "type": "p",
        "text": "É o enquadramento em determinado grau de risco tipificado pela Atual, com relação a Pessoas, Operações, Produtos e Serviços, resultando nos seguintes riscos:"
      },
      {
        "type": "ul",
        "items": [
      ...
      {
        "type": "p",
        "text": "Na Atual a determinação do risco das operações liquidadas com clientes está aderente aos requerimentos do Capítulo IV “Da Avaliação Interna de Risco” da Circular 3.978 do Banco Central do Brasil, e da Seção II do Capítulo V “Análise das Operações” da Instrução 617 da Comissão de Valores Mobiliários."
      }
    ]
  },
  {
    "id": "9-perfil-de-risco-e-atividades-da-empres",
    "title": "9. PERFIL DE RISCO E ATIVIDADES DA EMPRESA",
    "body": [
      {
        "type": "p",
        "text": "9.1 Ativos virtuais, stablecoins e remessas com uso de criptoativos"
      },
      {
        "type": "p",
        "text": "Além dos produtos e serviços tradicionais de câmbio, a Atual Câmbio deverá considerar, em sua abordagem baseada em risco, a eventual exposição a operações envolvendo ativos virtuais (incluindo stablecoins como USDT) e estruturas de remessas internacionais que utilizem ativos virtuais como meio técnico de liquidação. Tais operações tendem a apresentar risco inerente elevado, em especial quando: (i) houver uso de P2P/OTC; (ii) houver conversões rápidas e sucessivas; (iii) forem identificadas contrapartes em jurisdições de risco; (iv) houver sinais de tentativa de anonimização; ou (v) houver integração com provedores com controles insuficientes. A instituição deverá tratar essas exposições com controles reforçados, compatíveis com sua Avaliação Interna de Risco (AIR) e com a regulamentação aplicável."
      }
    ]
  },
  {
    "id": "10-risco-de-operacoes-de-clientes",
    "title": "10. RISCO DE OPERAÇÕES DE CLIENTES",
    "body": [
      {
        "type": "p",
        "text": "A Atual determina o grau de risco das Propostas de Operações com clientes com base no Capítulo IV “Da Avaliação Interna de Risco” da Circular 3.978 do Banco Central do Brasil, Seção II do Capítulo V “Análise das Operações” da Instrução 617 da CVM e Resolução CVM nº 50, de 31 de agosto de 2021."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "São levados em consideração o grau de risco de clientes, funcionários, fornecedores e prestadores de serviços de operações, de produtos e serviços e de parceiros de negócio."
      },
      {
        "type": "p",
        "text": "Tais procedimentos encontram-se descritos no Manual de KYC – Know Your Customer, Manual de KYE – Know Your Employee, Manual de KYP – Know Your Partner, Manual de KYS – Know Your Supplier e no Manual de Prevenção à Lavagem de Dinheiro e ao Financiamento do Terrorismo – PLD.FT."
      }
    ]
  },
  {
    "id": "11-risco-de-produtos-e-servicos",
    "title": "11. RISCO DE PRODUTOS E SERVIÇOS",
    "body": [
      {
        "type": "p",
        "text": "11.1 Exposição a criptoativos (on/off-ramp), stablecoins e remessas internacionais"
      },
      {
        "type": "p",
        "text": "Para fins de PLD/FT, são considerados produtos e serviços com potencial de risco aumentado aqueles que: (i) possibilitam elevada velocidade de movimentação; (ii) dificultam a identificação do beneficiário final; (iii) envolvem liquidação em múltiplas camadas/contrapartes; ou (iv) aumentam a complexidade de rastreabilidade. Quando houver oferta, intermediação, encaminhamento ou integração com operações de criptoativos (incluindo stablecoins como USDT), a Atual Câmbio deverá realizar avaliação prévia de riscos (inclusive riscos tecnológicos, de integridade e de terceiros), definir limites e alçadas, e implementar controles adicionais de identificação, registro, monitoramento e reporte, observando as novas normas do Banco Central do Brasil aplicáveis ao mercado de ativos virtuais."
      },
      {
        "type": "p",
        "text": "A Atual Câmbio mensura o grau de risco de produtos e de serviços disponibilizados a seus clientes, levando em consideração a abordagem de risco. Os produtos comercializados pela Atual passam por processo de homologação, levando em consideração os canais de distribuição e novas tecnologias, sendo estes de responsabilidade da Diretoria Executiva. A abordagem de risco do produto ou serviço é avaliada de acordo com o valor, risco e alçada responsável pela aprovação."
      }
    ]
  },
  {
    "id": "12-risco-de-funcionarios-parceiros-forne",
    "title": "12. RISCO DE FUNCIONÁRIOS, PARCEIROS, FORNECEDORES E DE PRESTADORES DE SERVIÇOS",
    "body": [
      {
        "type": "p",
        "text": "A Atual Câmbio realiza procedimentos adequados para seleção, análise e contratação de seus Funcionários e Colaboradores, através de: acompanhamento periódico da situação econômico-financeira, atos praticados que contrariem o Código de Ética e Conduta e princípios institucionais. Tais regras aplicam-se a todos os colaboradores que realizam atividades que determinam o grau de risco de Prospects e Clientes, Produtos e Serviços, Operações com Clientes, Fornecedores e Prestadores de Serviços. Os procedimentos destinados a conhecer os parceiros são realizados periodicamente pela atividade de PLD.FT."
      },
      {
        "type": "p",
        "text": "Tais procedimentos estão descritos no Manual de KYE – Know Your Employee, no Manual de KYP – Know Your Partner e no Manual de KYS – Know Your Supplier."
      },
      {
        "type": "p",
  ...
  {
    "id": "13-risco-de-prospects-e-clientes",
    "title": "13. RISCO DE PROSPECTS E CLIENTES",
    "body": [
      {
        "type": "p",
        "text": "Após receber os dados e a respectiva documentação, a atividade de PLD.FT da Atual Corretora de Câmbio realiza a análise sistêmica das informações e documentações, visando:"
      },
      {
        "type": "ul",
        "items": [
      ...
      {
        "type": "p",
        "text": "O registro dos documentos coletados no momento do cadastro ou atualização cadastral são armazenados pelo prazo de 10 (dez) anos, conforme determina o artigo 67 da Circular 3.978/20."
      },
      {
        "type": "p",
        "text": "A Atual Câmbio não exige do cliente documentos, dados ou certidões que estejam disponíveis em suas bases de dados ou em bases de dados públicas e privadas de acesso amplo, respeitando a Lei 14.286/21."
      }
    ]
  },
  {
    "id": "14-diligencias-de-conheca-seu-cliente",
    "title": "14. DILIGÊNCIAS DE CONHEÇA SEU CLIENTE",
    "body": [
      {
        "type": "p",
        "text": "Na Atual as diligências são realizadas através de ferramenta terceirizada, responsável por gerar relatórios consolidados com todas as informações normativamente requeridas, atreladas ao cliente. O grau de risco do cliente é mensurado após análise dos resultados capturados no relatório gerado, por meio da Matriz de Risco de Clientes e Operações."
      }
    ]
  },
  {
    "id": "15-funcoes-e-responsabilidades",
    "title": "15. FUNÇÕES E RESPONSABILIDADES",
    "body": [
      {
        "type": "p",
        "text": "15.1 Diretoria Executiva"
      },
      {
        "type": "p",
        "text": "Órgão da instituição responsável por apoiar a presente política, tendo como função e responsabilidade:"
      },
      {
        "type": "ul",
        "items": [
      ...
      {
        "type": "p",
        "text": "As deliberações da diretoria ocorrem, geralmente, de forma presencial, registradas em ata de reunião, o que não impede que ocorram alternativamente por meio eletrônico (e-mail), devidamente documentado."
      },
      {
        "type": "p",
        "text": "15.2 Compliance"
      },
      {
        "type": "p",
        "text": "A área de Compliance é responsável por efetivar a análise dos alertas de monitoramento, que pode a seu critério decidir:"
      },
      {
        "type": "ul",
        "items": [
  ...
  {
    "id": "16-identificacao-qualificacao-e-classifi",
    "title": "16. IDENTIFICAÇÃO, QUALIFICAÇÃO E CLASSIFICAÇÃO DE CLIENTES",
    "body": [
      {
        "type": "p",
        "text": "16.1 Conheça seu cliente – KYC"
      },
      {
        "type": "p",
        "text": "A Atual Câmbio, em conformidade com as legislações, com as regulamentações e com as boas práticas de mercado, adota procedimentos adequados destinados a conhecer seus clientes, com o objetivo de prevenir que utilizem os produtos e serviços comercializados para fins ilícitos, obter as informações necessárias e assegurar a identidade e a atividade econômica dos clientes, bem como a origem e a constituição de seu patrimônio e seus recursos financeiros. Além disso, evitar a responsabilização administrativa e criminal de seus diretores, funcionários e terceiros."
      },
      {
        "type": "p",
        "text": "Quanto mais precisas forem as informações coletadas e registradas no início do relacionamento, maior será a capacidade de identificação de atos ilícitos. Para os casos que requerem Especial Atenção, como o relacionamento com Pessoas Expostas Politicamente (PEPs) e clientes onde não foi possível identificar o beneficiário final, são adotados procedimentos específicos de análise."
      },
      {
        "type": "p",
        "text": "Na Atual Câmbio o cadastro de clientes de qualquer categoria de risco é atualizado a cada operação no caso de ato declaratório do cliente referente a atualização de informações e/ou documentos, e a cada 12 meses no teste de cadastro de clientes."
      },
      {
        "type": "p",
        "text": "16.2 Conheça seu funcionário – KYE"
      },
      {
        "type": "p",
        "text": "A Atual Câmbio definiu procedimentos descritos em manual específico para o tratamento do relacionamento com seus funcionários em consonância com as melhores práticas e a regulação vigente, sendo obrigatória a aprovação pela diretoria da Instituição."
      },
      {
        "type": "p",
        "text": "É um conjunto de regras, procedimentos e controles que devem ser adotados para seleção e a contratação de funcionários, bem como durante o relacionamento com os funcionários, tendo como objetivo o adequado tratamento do risco de LD/FT, assegurando a adequada capacitação dos funcionários sobre o tema, bem como permitindo um acompanhamento da situação econômico-financeira e idoneidade, visando evitar vínculo com pessoas envolvidas em atos ilícitos."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Os procedimentos devem garantir o conhecimento do funcionário, com sua identificação e qualificação, e devem ser compatíveis com esta política, bem como alinhados à avaliação interna de riscos. Após as etapas anteriores o funcionário é classificado na categoria de risco."
      },
      {
        "type": "p",
        "text": "As informações devem ser mantidas atualizadas, sendo a periodicidade de atualização dos dados orientada pela classificação interna de riscos. Adicionalmente, são adotados procedimentos de monitoramento sobre a conduta do associado ao longo de sua trajetória dentro da instituição."
      },
      {
        "type": "p",
        "text": "Na Atual Câmbio o cadastro de funcionários e de colaboradores é atualizado por ato declaratório ou por meio de revisão periódica. Todos os procedimentos destinados a conhecer os funcionários devem estar disponíveis para acesso ao órgão regulador pelo período requerido na regulamentação em vigor."
      },
      {
        "type": "p",
        "text": "O mesmo se aplica aos funcionários e colaboradores da estrutura de correspondentes cambiais contratados, devendo ser aplicado periodicamente a todos o treinamento de lavagem de dinheiro e ao financiamento do terrorismo."
      },
      {
        "type": "p",
        "text": "16.3 Conheça seu parceiro – KYP"
      },
      {
        "type": "p",
        "text": "A Atual Câmbio possui regras e controles para manutenção de relacionamento com parceiros comerciais, dentre os quais se destacam, em geral, agentes autônomos de investimentos, correspondentes bancários, gestores, administradores, distribuidores e custodiantes de ativos, prestadores de serviços terceirizados."
      },
      {
        "type": "p",
        "text": "A depender do tipo de relação de negócio com o parceiro comercial, a Atual Câmbio aplica procedimentos de Due Diligence reforçados, visando garantir a adequabilidade do modelo de atuação do parceiro aos princípios éticos da instituição."
      },
      {
        "type": "p",
        "text": "Na Atual Câmbio o cadastro de parceiros de negócio é atualizado por ato declaratório levado a conhecimento da atividade de PLD.FT, referente a atualização de informações e/ou documentos, ou por meio de revisão periódica."
      },
      {
        "type": "p",
        "text": "16.4 Conheça seu fornecedor – KYS"
      },
      {
        "type": "p",
        "text": "A Atual Câmbio detém políticas, procedimentos e controles internos para prevenir riscos reputacionais e riscos regulatórios na contratação de fornecedores de serviços diversos. A identificação dos sócios e dos beneficiários finais é essencial para mitigar o risco, prevenindo relacionamento comercial com pessoas inidôneas, por meio de pesquisas midiáticas e outros controles."
      },
      {
        "type": "p",
        "text": "Na Atual Câmbio o cadastro de fornecedores é atualizado por ato declaratório levado a conhecimento do departamento de Compliance, ou por meio de revisão periódica realizada pelo Compliance."
      }
    ]
  },
  {
    "id": "17-registro-de-operacoes-financeiras-e-d",
    "title": "17. REGISTRO DE OPERAÇÕES FINANCEIRAS E DE SERVIÇOS FINANCEIROS",
    "body": [
      {
        "type": "p",
        "text": "No caso de operações com exposição a ativos virtuais, o registro de operações deve contemplar, quando aplicável, além dos campos já adotados: (i) identificação do prestador de serviço parceiro (PSAV); (ii) identificação do ativo virtual (ex.: stablecoin); (iii) endereços de origem/destino; (iv) hashes de transação; (v) dados do originador e do beneficiário; e (vi) evidências de diligência e validação, observando os prazos de guarda previstos na regulamentação e os requisitos de integridade e auditabilidade."
      },
      {
        "type": "p",
        "text": "O registro de Operações Financeiras e Serviços Financeiros visa:"
      },
      {
        "type": "ul",
        "items": [
  ...
  {
    "id": "18-controles-de-identificacao-de-pessoas",
    "title": "18. CONTROLES DE IDENTIFICAÇÃO DE PESSOAS PUNIDAS",
    "body": [
      {
        "type": "p",
  ...
  },
  {
    ...
    "body": [
      ...
      {
        "type": "p",
        "text": "As análises devem ser registradas com evidências apropriadas, incluindo, quando aplicável, endereços, hashes de transação, telas de sistemas e relatórios de diligência."
      },
      {
        "type": "p",
        "text": "A Atual possui procedimentos e controles internos destinados a monitorar as movimentações e operações financeiras realizadas por seus clientes, por meio de regras diversas, devidamente parametrizadas no sistema de monitoramento, com objetivo de identificar, selecionar e analisar tempestivamente as situações atípicas que possam configurar indícios de lavagem de dinheiro e financiamento do terrorismo."
      },
      {
        "type": "p",
        "text": "A Atual observa e adota os devidos controles de monitoramento, seleção e análise de operações para todas as situações previstas na regulamentação que podem constituir indícios de Lavagem de Dinheiro e Financiamento do Terrorismo, destinadas aos produtos e serviços ofertados pela corretora, essencialmente detalhadas no manual de PLD/FT."
      },
      {
        "type": "p",
        "text": "As análises conclusivas dos alertas selecionados para análise são adequadamente registradas e arquivadas minimamente no prazo regulamentar pela atividade de PLD.FT."
      }
    ]
  },
  {
    "id": "20-comunicacoes-de-operacoes-suspeitas-a",
    "title": "20. COMUNICAÇÕES DE OPERAÇÕES SUSPEITAS AOS REGULADORES",
    "body": [
      {
        "type": "p",
        "text": "As operações, propostas de operações e situações suspeitas envolvendo criptoativos (incluindo stablecoins) devem ser tratadas com a mesma diligência e tempestividade previstas nesta Política, incluindo a consolidação do dossiê, análise pela área de Compliance e deliberação pela Diretoria Executiva para comunicação aos órgãos competentes, conforme o caso (COAF e/ou demais autoridades), observadas as regras de sigilo e a regulamentação aplicável."
      },
      {
        "type": "p",
        "text": "As situações, operações ou ainda propostas de operações que configurem indícios de lavagem de dinheiro, financiamento do terrorismo ou práticas abusivas no mercado de capitais, especialmente aquelas hipóteses designadas nas regulamentações vigentes, devem ser comunicadas ao Conselho de Controle de Atividades Financeiras (COAF) e demais órgãos conforme o caso."
      },
      {
        "type": "p",
        "text": "A Diretoria Executiva é responsável por decidir pelas comunicações, após apreciação dos dossiês elaborados pela atividade de PLD.FT. As deliberações ocorrem em reunião presencial (com registro em ata) ou via e-mail."
      },
      {
        "type": "p",
        "text": "As análises documentais conclusivas que suportam as decisões de comunicar, ou não, situações, operações ou propostas de operações aos reguladores, inclusive documentações deliberativas da Diretoria Executiva, são adequadamente registradas e arquivadas pela atividade de PLD.FT."
      }
    ]
  },
  {
    "id": "21-contratacao-de-funcionarios-prestador",
    "title": "21. CONTRATAÇÃO DE FUNCIONÁRIOS, PRESTADORES DE SERVIÇOS TERCEIRIZADOS E PARCEIROS",
    "body": [
      {
        "type": "p",
        "text": "Antes da contratação de funcionários, prestadores de serviços terceirizados e parceiros, a Atual Câmbio realiza:"
      },
      {
        "type": "ul",
        "items": [
  ...
  {
    "id": "22-treinamento-de-pld-ft",
    "title": "22. TREINAMENTO DE PLD/FT",
    "body": [
      {
        "type": "p",
        "text": "Os funcionários, colaboradores, diretores e estagiários devem estar adequadamente treinados no tema Prevenção à Lavagem de Dinheiro e ao Financiamento do Terrorismo. Para isso, a Atual aplica treinamentos periódicos e obrigatórios, que visam orientar aos associados acerca da temática em questão, bem como reforçar a necessidade do cumprimento dos procedimentos dispostos neste documento."
      },
      {
        "type": "p",
        "text": "O treinamento é aplicado quando da admissão e anualmente como forma de reciclagem. Os treinamentos podem ser presenciais ou online, com avaliação de conhecimento ao final do módulo. O material utilizado nos treinamentos aborda tópicos que são considerados importantes de acordo com a regulamentação vigente, tais como: conceitos e procedimentos inerentes ao tema de PLD/FT, destacando as responsabilidades de cada pessoa na gestão destes riscos no limite de suas atribuições."
      }
    ]
  },
  {
    "id": "23-avaliacao-de-efetividade",
    "title": "23. AVALIAÇÃO DE EFETIVIDADE",
    "body": [
      {
        "type": "p",
        "text": "A Atual realizará na data-base de 31 de dezembro de cada ano, a partir de 2024, a Avaliação de Efetividade da Política, dos controles internos e procedimentos voltados à Prevenção à Lavagem de Dinheiro e ao Financiamento do Terrorismo."
      },
      {
        "type": "p",
        "text": "Essa avaliação será devidamente aprovada pela Diretoria Executiva até 31 de março do ano seguinte ao da data-base de realização do relatório."
      },
      {
        "type": "p",
        "text": "Deve conter informações sobre os requisitos do Capítulo XI da Circular 3.978/20, a saber:"
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Na existência de deficiências identificadas na Avaliação de Efetividade, essas são formalizadas em Plano de Ação (plano de regularização) com as medidas corretivas, com posterior emissão de relatório de acompanhamento da resolução de tais medidas."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Caso sejam identificadas deficiências na avaliação, deve ser formalizado um Plano de Ação (plano de regularização) com as medidas corretivas. O referido plano de ação deve ser acompanhado pela auditoria interna e aprovado pela diretoria executiva."
      }
    ]
  },
  {
    "id": "24-governanca-na-oferta-de-produtos-serv",
    "title": "24. GOVERNANÇA NA OFERTA DE PRODUTOS, SERVIÇOS, CANAIS E TECNOLOGIAS",
    "body": [
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Toda nova oferta de produto, serviço e canal de comercialização para o cliente, assim como a utilização de novas tecnologias, deverá conter em sua documentação a aprovação da atividade de PLD.FT, responsável por identificar os riscos inerentes à lavagem de dinheiro, financiamento ao terrorismo e práticas abusivas existentes na estrutura proposta, e eventual necessidade de implementação de novos controles."
      }
    ]
  },
  {
    "id": "25-canal-de-denuncias",
    "title": "25. CANAL DE DENÚNCIAS",
    "body": [
      {
        "type": "p",
        "text": "A Atual Câmbio disponibiliza canal específico para o recebimento de denúncias disponível em seu sítio eletrônico (Canal de Denúncias – Atual Câmbio), inclusive as anônimas, de fatos suspeitos ou indícios de relação direta ou indireta com infrações relacionadas à lavagem de dinheiro, financiamento ao terrorismo ou realização de práticas abusivas contra o mercado de capitais, as quais são submetidas para análise e devidas providências da atividade de PLD.FT."
      },
      {
        "type": "p",
        "text": "É dever de todos os funcionários, estagiários, administradores, prestadores de serviços relevantes e parceiros comerciais efetuar reporte imediato à atividade de PLD.FT, preferencialmente pelo canal de denúncias, em caso de observância de qualquer situação como suspeita, de acordo com as diretrizes estabelecidas neste documento, para que a Atual tome as medidas cabíveis tempestivamente."
      }
    ]
  },
  {
    "id": "26-sigilo-das-informacoes",
    "title": "26. SIGILO DAS INFORMAÇÕES",
    "body": [
      {
        "type": "p",
        "text": "Todas as informações que tratam de indícios / suspeitas de lavagem de dinheiro e combate ao financiamento do terrorismo são de caráter confidencial, não devendo, em hipótese alguma, serem disponibilizadas a terceiros e ao cliente."
      },
      {
        "type": "p",
        "text": "As comunicações de casos suspeitos que tratam a Circular Banco Central 3.978/20 e a Carta Circular 4.001/20 não devem ser levadas ao conhecimento de qualquer terceiro, inclusive do cliente envolvido. Os colaboradores da atividade de PLD.FT, dentro de suas responsabilidades e suas atribuições, estão autorizados a participar do processo de identificação e reporte de operações e de situações suspeitas exclusivamente para os órgãos fiscalizadores e reguladores, que por sua vez utilizam estas informações para seguirem com as tratativas investigatórias."
      }
    ]
  },
  {
    "id": "27-auditoria-interna",
    "title": "27. AUDITORIA INTERNA",
    "body": [
      {
        "type": "p",
        "text": "Anualmente, os procedimentos e controles de Prevenção à Lavagem de Dinheiro e ao Financiamento do Terrorismo são avaliados pela Auditoria Interna da Atual Corretora, sendo emitidos recomendações de melhoria e planos de ação das medidas corretivas."
      }
    ]
  },
  {
    "id": "28-consideracoes-finais",
    "title": "28. CONSIDERAÇÕES FINAIS",
    "body": [
      {
        "type": "p",
        "text": "Sendo comprovado o descumprimento das normas aqui expostas, bem como os dispostos legais e regulamentares, estão sujeitos seus funcionários e demais pessoas obrigadas a aderir e seguir esta política às penalidades administrativas e criminais decorrentes de atos de lavagem de dinheiro, do financiamento do terrorismo, fraudes, sinistros, corrupção e outros atos ilícitos."
      },
      {
        "type": "p",
        "text": "No que tange à manutenção e guarda de informações, devem ser mantidos em sua forma original ou em arquivos eletrônicos, conforme prazos e responsabilidades estabelecidos pela legislação vigente. Dúvidas ou esclarecimentos adicionais devem ser direcionados à atividade de PLD.FT, através do e-mail controles.internos@atualcambio.com.br."
      }
    ]
  },
  {
